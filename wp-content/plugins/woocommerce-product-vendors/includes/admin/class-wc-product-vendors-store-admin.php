...
class WC_Product_Vendors_Store_Admin {
	...
	public static function init() {
		...
		add_action( 'woocommerce_process_product_meta_simple', array( self::$self, 'save_product_pass_shipping_tax_field_general' ) );
		add_action( 'woocommerce_process_product_meta_booking', array( self::$self, 'save_product_pass_shipping_tax_field_general' ) );

		// save pass shipping/tax field for variable product general tab
		add_action( 'woocommerce_process_product_meta_variable', array( self::$self, 'save_product_pass_shipping_tax_field_general' ) );
