...
class UM_WooCommerce_API {
	...
	function __construct() {
		...
		add_action( 'wp_ajax_um_woocommerce_add_review',array( $this->api(), 'ajax_add_review' )    );
	...
	function wp_enqueue_scripts() {
		...
		wp_register_script( 'um-woocommerce', um_woocommerce_url . 'assets/js/um-woocommerce.js', array( 'jquery', 'select2', 'wp-util', 'um_raty', 'um_scripts' ), um_woocommerce_version, true );
