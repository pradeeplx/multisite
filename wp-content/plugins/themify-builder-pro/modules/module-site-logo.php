		...
		$general = array(
			...
			self::get_expand('f', array(
				self::get_tab(array(
					'n' => array(
					'options' => array(
						self::get_font_family(array('',' > h1',' > h2',' > h3',' > h4',' > h5',' > h6',' > p'), 'f_f_g'),
						self::get_color_type(array('', ' a'),'', 'f_c_t',  'f_c', 'f_g_c'),
						self::get_font_size(array('',' > h1',' > h2',' > h3',' > h4',' > h5',' > h6',' > p'), 'f_s_g', ''),
						self::get_line_height(array('',' > h1',' > h2',' > h3',' > h4',' > h5',' > h6',' > p'), 'l_h_g'),
						self::get_letter_spacing(array('',' > h1',' > h2',' > h3',' > h4',' > h5',' > h6',' > p'), 'l_s_g'),
						self::get_text_align(array('',' > h1',' > h2',' > h3',' > h4',' > h5',' > h6',' > p'), 't_a_g'),
						self::get_text_transform(array('',' > h1',' > h2',' > h3',' > h4',' > h5',' > h6',' > p'), 't_t_g'),
						self::get_font_style(array('',' > h1',' > h2',' > h3',' > h4',' > h5',' > h6',' > p'), 'f_st_g', 'f_w_g'),
						self::get_text_decoration(array('',' > h1',' > h2',' > h3',' > h4',' > h5',' > h6',' > p'), 't_d_r_g'),
						self::get_text_shadow(array('',' > h1',' > h2',' > h3',' > h4',' > h5',' > h6',' > p'),'t_sh_g'),
					)
					),
					'h' => array(
					'options' => array(
						self::get_font_family(array('',':hover > h1',':hover > h2',':hover > h3',':hover > h4',':hover > h5',':hover > h6',':hover > p'), 'f_f_g_h', ''),
						self::get_color_type(array(':hover', ':hover a'),'', 'f_c_t_h',  'f_c_h', 'f_g_c_h',''),
						self::get_font_size(array(':hover > h1',':hover > h2',':hover > h3',':hover > h4',':hover > h5',':hover > h6',':hover > p'), 'f_s_g_h', '', ''),
						self::get_line_height(array(':hover > h1',':hover > h2',':hover > h3',':hover > h4',':hover > h5',':hover > h6',':hover > p'), 'l_h_g_h', ''),
						self::get_letter_spacing(array(':hover > h1',':hover > h2',':hover > h3',':hover > h4',':hover > h5',':hover > h6',':hover > p'), 'l_s_g_h', ''),
						self::get_text_align(array(':hover > h1',':hover > h2',':hover > h3',':hover > h4',':hover > h5',':hover > h6',':hover > p'), 't_a_g_h', ''),
						self::get_text_transform(array(':hover > h1',':hover > h2',':hover > h3',':hover > h4',':hover > h5',':hover > h6',':hover > p'), 't_t_g_h', ''),
						self::get_font_style(array(':hover > h1',':hover > h2',':hover > h3',':hover > h4',':hover > h5',':hover > h6',':hover > p'), 'f_st_g_h', 'f_w_g_h', ''),
						self::get_text_decoration(array(':hover > h1',':hover > h2',':hover > h3',':hover > h4',':hover > h5',':hover > h6',':hover > p'), 't_d_r_g_h', ''),
						self::get_text_shadow(array(':hover > h1',':hover > h2',':hover > h3',':hover > h4',':hover > h5',':hover > h6',':hover > p'),'t_sh_g_h',''),
					)
					)
				))
			)),
