						...
						<div class="vendor_capability">
							...
							<div class="vendor_other_capability">
								...
								if( WCFM_Dependencies::wcfmu_plugin_active_check() ) {
									...
									if( method_exists( 'WCFMu_Dependencies', 'wcfm_wc_quotation_active_check' ) && WCFMu_Dependencies::wcfm_wc_tabs_manager_plugin_active_check() ) {
									...
									if( method_exists( 'WCFMu_Dependencies', 'wcfm_wc_quotation_active_check' ) && WCFMu_Dependencies::wcfm_wc_advanced_product_labels_active_check() ) {
