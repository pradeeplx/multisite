...
if ( ! function_exists( 'um_theme_customizer_head_styles' ) ) {
	function um_theme_customizer_head_styles() {
		...
		if ( function_exists( 'um_groups_plugins_loaded' ) ) :
			...
			$css .= '
				...
				#um-groups-filters ul.filters li.active {
					background-color:' . sanitize_hex_color( $defaults['um_theme_ext_group_filter_active_bg'] ) . ' !important;
				}

				#um-groups-filters ul.filters li.active a{
					color:' . sanitize_hex_color( $defaults['um_theme_ext_group_filter_active_text'] ) . ' !important;
				}

				.active .group-filter-item span{
					border-left-color:' . sanitize_hex_color( $defaults['um_theme_ext_group_filter_active_text'] ) . '!important;
				}

				#um-groups-filters ul.filters li{
					background-color:' . sanitize_hex_color( $defaults['um_theme_ext_group_filter_bg'] ) . ';
				}

				#um-groups-filters ul.filters li a{
					color:' . sanitize_hex_color( $defaults['um_theme_ext_group_filter_text'] ) . '!important;
				}

				.group-filter-item span{
					border-left-color:' . sanitize_hex_color( $defaults['um_theme_ext_group_filter_text'] ) . '!important;
				}
		...
		if ( class_exists( 'FMWP' ) ) :
			...
			.fmwp-forum-title{
				color: ' . sanitize_hex_color( $defaults['um_forumwp_forum_title_color'] ) . '!important;
			}
			...
			.fmwp-child-reply{
				background-color: ' . sanitize_hex_color( $defaults['um_forumwp_reply_box_color'] ) . '!important;
			}
