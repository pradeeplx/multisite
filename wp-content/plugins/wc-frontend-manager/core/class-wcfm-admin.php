...
class WCFM_Admin {
	...
	public function wcfm_wcfmu_inactive_notice() {
		...
		$offer_key = 'wcfm_wcfmu_inactive24082019';
    ...
    /*$offer_msg = __( '<h2>
		...
		?>
			<div class="notice is-dismissible wcfm_addon_inactive_notice_box wcfm_ultimate_inactive_notice_box" id="wcfm-ultimate-notice">
				<img class="wcfm_logo" src="https://wclovers.com/wp-content/uploads/2019/07/wcfm_marketplace_white_ogo.png" alt="">
				<?php echo $offer_msg; ?>
				<span class="dashicons dashicons-megaphone"></span>
				<a href="https://wclovers.com/product/woocommerce-frontend-manager-ultimate/" class=" button-primary promo-btn" target="_blank"><?php _e( 'GET Ultimate', 'wc-multivendor-marketplace' ); ?></a>
			</div>
	...
	public function wcfm_wcfmgs_inactive_notice() {
		...
		// check if it has already been dismissed
		$offer_key = 'wcfm_wcfmgs_inactive24082019';
		$hide_notice = get_option( $offer_key . '_tracking_notice', 'no' );
		...
		?>
			<div class="notice is-dismissible wcfm_addon_inactive_notice_box wcfm_group_inactive_notice_box" id="wcfm-groups-sttafs-notice">
				<img src="https://wclovers.com/wp-content/uploads/2019/07/wcfm_marketplace_white_ogo.png" alt="">
				<?php echo $offer_msg; ?>
				<span class="dashicons dashicons-groups1"></span>
				<a href="http://wclovers.com/product/woocommerce-frontend-manager-groups-staffs/" class="promo-btn wcfmgs_promo_button" target="_blank"></a>
			</div>
