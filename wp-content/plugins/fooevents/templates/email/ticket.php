                                ...
                                <td>
                                    <table width="260" border="0" cellspacing="0" cellpadding="0" align="center" style="background-color:#ffffff;border-collapse:collapse" class="contenttable contenttable_text_inner">
                                        ...
                                        <?php if($ticket['WooCommerceEventsTicketDisplayPrice'] != 'off') :?>
                                            <tr><td style="font-size:14px;color:#777777"><?php _e('Price:', 'woocommerce-events'); ?> <?php echo $ticket['WooCommerceEventsPrice']; ?></td></tr>
                                        <?php endif; ?>    
                                        ...
                                        <?php endif; ?>
                                        <?php if(!empty($ticket['fooevents_custom_attendee_fields_options']) && $ticket['WooCommerceEventsIncludeCustomAttendeeDetails'] != 'off') :?>
                                            <tr>
                                        ...
                                        <?php endif; ?>   
                                         <?php if(!empty($ticket['fooevents_seating_options'])) :?>
                                            <tr>
                                                <td style="font-size:14px;color:#777777">
                                                    <?php echo $ticket['fooevents_seating_options']; ?>
                                                </td>
                                            </tr>
                                        <?php endif; ?>    
                                        <tr><td><img style="display:block;" src="<?php echo $eventPluginURL.'/images/'; ?>spacer_ver_20px.jpg" /></td></tr>
