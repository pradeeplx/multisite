...
/**
 * Action: Verify user when update profile if complate
 * @hook 'um_update_profile_full_name' from um_user_edit_profile()
 * @param int $user_id
 */
function um_verify_user_if_complate( $user_id ) {
...
add_action( 'um_update_profile_full_name',  'um_verify_user_if_complate', 20, 2 );