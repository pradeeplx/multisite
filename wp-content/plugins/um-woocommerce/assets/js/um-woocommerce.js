jQuery(document).ready(function() {
	...
	jQuery(".um-reviews-rate i").live('click',function(){

		   var retingNo=jQuery(this).attr('data-alt');
		   jQuery("#selected-review").val(retingNo);
		    jQuery(".um-reviews-rate i ").addClass("star-off-png");
		    jQuery(".um-reviews-rate i").removeClass("star-on-png");
		   jQuery(".um-reviews-rate i").each(function(){
		     var currentIcon=jQuery(this).attr('data-alt');
		     if(retingNo >= currentIcon ){
		       jQuery(this).removeClass("star-off-png");
		       jQuery(this).addClass("star-on-png");
		     }
		  })
		})
	...
	jQuery( document.body ).on('click', '.um-woo-add-review', function(e){
		...
		wp.ajax.send( 'um_woocommerce_add_review', {
