		...
		$general = array(
			...
			self::get_expand('bg', array(
				self::get_tab(array(
					'n' => array(
					'options' => array(
						self::get_image(' img', 'b_i','bg_c','b_r','b_p')
					)
					),
					'h' => array(
					'options' => array(
						self::get_image(' img', 'b_i','bg_c','b_r','b_p', 'h')
					)
					)
				))
			)),
			...
			self::get_expand('p', array(
				self::get_tab(array(
					'n' => array(
					'options' => array(
						self::get_padding(' img', 'p')
					)
					),
					'h' => array(
					'options' => array(
						self::get_padding(' img', 'p', 'h')
					)
					)
				))
			)),
			...
			self::get_expand('m', array(
				self::get_tab(array(
					'n' => array(
					'options' => array(
						self::get_margin(' img', 'm')
					)
					),
					'h' => array(
					'options' => array(
						self::get_margin(' img', 'm', 'h')
					)
					)
				))
			)),
			...
			self::get_expand('sh', array(
				self::get_tab(array(
					'n' => array(
						'options' => array(
							self::get_box_shadow(' img', 'sh')
						)
					),
					'h' => array(
						'options' => array(
							self::get_box_shadow(' img', 'sh', 'h')
						)
					)
				))
			)),
