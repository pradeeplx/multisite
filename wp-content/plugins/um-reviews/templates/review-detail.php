...
<span class="um-reviews-detail">
	...
	<a href="<?php echo esc_url( $star_rating_url ); ?>" class="um-reviews-d-p um-tip-n" title="<?php echo sprintf( __( '%s reviews (%s)', 'um-reviews' ), $count_of_reviews, $progress . '%' ); ?>"><span data-width="<?php echo $progress; ?>"></span></a>
