		...
		$general = array(
			...
			self::get_expand('f', array(
				self::get_tab(array(
					'n' => array(
					'options' => array(
						self::get_font_family(' .tbp_site_tagline_heading', 'f_f_g'),
						self::get_color_type(' .tbp_site_tagline_heading','', 'f_c_t_g',  'f_c_g', 'f_g_c_g'),
						self::get_font_size(' .tbp_site_tagline_heading', 'f_s_g', ''),
						self::get_line_height(' .tbp_site_tagline_heading', 'l_h_g'),
						self::get_letter_spacing(' .tbp_site_tagline_heading', 'l_s_g'),
						self::get_text_align(' .tbp_site_tagline_heading', 't_a_g'),
						self::get_text_transform(' .tbp_site_tagline_heading', 't_t_g'),
						self::get_font_style(' .tbp_site_tagline_heading', 'f_st_g', 'f_w_g'),
						self::get_text_decoration(' .tbp_site_tagline_heading', 't_d_r_g'),
						self::get_text_shadow(' .tbp_site_tagline_heading','t_sh_g','h'),
					)
					),
					'h' => array(
					'options' => array(
						self::get_font_family(' .tbp_site_tagline_heading', 'f_f_g_h', 'h'),
						self::get_color_type(' .tbp_site_tagline_heading:hover','', 'f_c_t_g_h',  'f_c_g_h', 'f_g_c_g_h', 'h'),
						self::get_font_size(' .tbp_site_tagline_heading', 'f_s_g', '', 'h'),
						self::get_line_height(' .tbp_site_tagline_heading', 'l_h_g', 'h'),
						self::get_letter_spacing(' .tbp_site_tagline_heading', 'l_s_g', 'h'),
						self::get_text_align(' .tbp_site_tagline_heading', 't_a_g', 'h'),
						self::get_text_transform(' .tbp_site_tagline_heading', 't_t_g', 'h'),
						self::get_font_style(' .tbp_site_tagline_heading', 'f_st_g', 'f_w_g', 'h'),
						self::get_text_decoration(' .tbp_site_tagline_heading', 't_d_r_g', 'h'),
						self::get_text_shadow(' .tbp_site_tagline_heading','t_sh_g','h'),
					)
					)
				))
