...
if ( UM()->Reviews_API()->api()->can_flag( $review_id ) ) { ?>
	...
	<div class="um-reviews-flag"><a href="#"><i class="um-faicon-flag"></i> <span><?php _e( 'Report', 'um-reviews' ); ?></span></a></div>

<?php }

if ( $reviewer_id == $my_id && UM()->Reviews_API()->api()->already_reviewed( $user_id ) ) { ?>

	<div class="um-reviews-edit"><a href="#"><i class="um-faicon-pencil"></i> <span><?php _e( 'Edit', 'um-reviews' ); ?></span></a></div>
...
if ( UM()->Reviews_API()->api()->can_remove( $reviewer_id ) ) { ?>
	...
	<div class="um-reviews-remove"><a href="#" data-review_id="'. $review_id .'" data-remove="<?php esc_attr_e( 'Are you sure you want to remove this review?', 'um-reviews' ); ?>"><i class="um-faicon-trash"></i> <span><?php _e( 'Remove', 'um-reviews' ); ?></span></a></div>
