...
function ub_get_modules_list( $mode = 'full' ) {
	...
	$modules = array(
		...
		'admin/menu.php' => array(
			...
			'description' => __( 'This module allows you to customize the admin menu. Enable the Link Manager, remove the permalinks configuration option or remove "Dashboard" link from admin panel for users without site (in WP Multisite).', 'ub' ),
			'group' => 'admin',
			'public' => true,
			'wp' => '3.5',
